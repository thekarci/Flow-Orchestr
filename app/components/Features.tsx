  ...
  const features = [
    {
      ...
      description: "Deploy in minutes with 30,000 GPUs available now. No waitlists, no approval process, no enterprise contracts.",
      icon: (
    ...
    },
    {
      ...
      description: "Mix GPU types, adjust on the fly, pay only for what you use. Scale up for training, down for inference. No minimums or commitments.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "H100s from $2.19/hr vs AWS at $12.29/hr. Transparent pricing, no hidden fees. Most startups save $10k+ monthly.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Open Source",
      description: "Cut GPU costs by up to 70%. Full compliance and seamless integration with existing MLOps/DevOps workflows.",
      icon: (
